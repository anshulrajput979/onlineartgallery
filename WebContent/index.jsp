...
<div class="slider">
    <ul class="slides">
      <li>
       ...
       <li>
        <img src="Images/2.jpg" style="width:100%"> random image
      ...
      <li>
        <img src="Images/3.jpg" style="width:100%"> random image
      ...
      <li>
        <img src="Images/4.jpg" style="width:100%"> random image
        <div class="caption center-align">
          <h3>This is our big Tagline!</h3>
          <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5>
        </div>
  ...
  <div class="mySlides fade">
    ...
    <img src="WebContent/Images/nature3.jpg">
